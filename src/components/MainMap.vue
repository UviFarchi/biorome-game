...
import StatusBar from '@/components/subcomponents/StatusBar.vue';
import AssembliesMenu from "@/components/subcomponents/AssembliesMenu.vue";
import OrdersMenu from "@/components/subcomponents/OrdersMenu.vue";
import PlantsMenu from "@/components/subcomponents/PlantsMenu.vue";
import AnimalsMenu from "@/components/subcomponents/AnimalsMenu.vue";
...
import TilesGrid from "@/components/subcomponents/TilesGrid.vue";
